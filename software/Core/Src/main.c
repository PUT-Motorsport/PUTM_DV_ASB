...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD_OK_Pin|LD_WARN_Pin|LD_CHK_Pin|AS_CLOSE_SDC_Pin
                          |AS_MODE_Pin|WATCHDOG_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, spare1_Pin|spare2_Pin|VALVE1_Pin|VALVE2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LD_OK_Pin LD_WARN_Pin LD_CHK_Pin AS_CLOSE_SDC_Pin
                           AS_MODE_Pin WATCHDOG_Pin */
  GPIO_InitStruct.Pin = LD_OK_Pin|LD_WARN_Pin|LD_CHK_Pin|AS_CLOSE_SDC_Pin
                          |AS_MODE_Pin|WATCHDOG_Pin;
  ...
  /*Configure GPIO pin : LD_ERROR_Pin */
